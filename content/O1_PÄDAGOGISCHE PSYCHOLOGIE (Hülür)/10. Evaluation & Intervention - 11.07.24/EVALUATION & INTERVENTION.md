...
summative: ein Prdukt wird newerden , Formativ: ein prozess wird bewertet :: Intern zb. UniEvaluation, externe durch behörde,, Ranking im Rahmen der PISA Studie


### Evaluation
#### Komponenten, Taxonomie, Ablauf
> [!note] Was ist "Evaluation"
> 
...
>
>
>> [!qq]- Was sind die [[Komponenten der Evaluation]] und welchen Inhalt haben diese?
...
>
>
>> [!qq]- Welche [[Arten der Evaluation]] gibt's, was sind ihre Unterschiede?



#### Überprüfung der Wirksamkeit von Interventionen
> [!info] Wie funktioniert Evaluation?
...
>
>
>> [!qq]- Was ist beim "Vortest-Nachtest-Follow-Up-Plan" Wichtig?
>> - Man braucht Kontroll- & Interventionsgruppe
>> - Zielvariablen soll direkt vor und direkt im Anschluss an Intervention erhoben werden
...
>
>
>> [!qq]- Welche Probleme treten auf wenn die Ausgangslage bei EG vs. KG nicht die gleiche ist?
>> - Wichtig: Zu Beginn einer Intervention sollten KEINE Unterschiede zw. EG & KG bestehen - sonst methodische Probleme
>> 	- [[Regression zur Mitte]]
>> 	- Im Falle ungleicher Ausgangswerte kann man [[Kovarianzanalyse]] machen, um die bestehenden Unterschiede herauszupartialisieren
...
>
>
>> [!qq]- Was ist eventuell das Problem, wenn man [[Cohen's d]] zur Beurteilung der Effektivität einer Intervention heranzieht?
>> - Die "Konventionen für die Interpretation von Effektstärken" sind evtl. nicht hinreichend für die Beurteilung, ob eine Intervention wirksam war
>> - -> Deshalb sollten auch andere Kriterien wie z.B. "Leistungszuwachs in einem Schuljahr" herangezogen werden
...
>
>
>> [!qq]- Wie gut war die Intervention: Effektivität, Effizienz, Kosten-Nutzen-Analyse
>> - Effektivität: Wirksamkeit einer Maßnahme
>> - Effizienz: Aufwand einer Intervention in Relation zu den Erträgen
...
- [[Äquivalenzprobleme]]
- Problem mit <span style="color:rgb(255, 255, 0)">Hierarchischen Daten</span>: [[Klumpenstichproben]] 

- [[Stichprobenmortalität]]
	- Statistische Lösungen für fehlende Daten
		- [[Multiple Imputation]]
		- <span style="color:rgb(255, 255, 0)">Full-information-maximum-likelihood-Verfahren</span>
...
>
>
>> [!qq]- Was sind Standards für Evaluationen?
>> ![[Pasted image 20240713172822.png]]
...
>
>
>> [!qq]- Erkläre die Aspekte der [[Präventive Intervention]]: primäre, sekundäre, tertiäre Prävention 


#### Schwerpunkte von päd.-psych. Trainingsprogrammen für Kindergarten- & Vorschulkinder
