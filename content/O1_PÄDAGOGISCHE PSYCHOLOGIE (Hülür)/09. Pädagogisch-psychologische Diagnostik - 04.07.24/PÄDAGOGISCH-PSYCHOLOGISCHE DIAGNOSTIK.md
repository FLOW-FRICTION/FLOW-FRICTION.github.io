...
>
>
>> [!qq]- Was können nach der Taxonomie von Pawlik (1982) Diagnostische Ziele sein?
>> - Status- vs. Prozessdiagnostik
>> - Selektions- vs. Modifikationsdiagnostik
>> 	- Personen- und Bedingungsselektion
>> 	- Modifikation des Verhaltens und Bedingungsmodifikation
...
- [ ] 🔰
- [ ] ✅
> [!qq]- Was ist ein Konstrukt?
> - Ein Konstrukt ist ein nicht direkt beobachtbarer Sachverhalt innerhalb einer wissenschaftlichen Theorie.
> - Konstrukte sind gedanklicher bzw. theoretischer Natur
>   
> - In der pädagogisch-psychologischen Diagnostik sind Konstrukte insbesondere interessierende Merkmale in Beobachtungseinheiten – in der Regel Personen
> - Durch Operationalisierung und statistische Abstraktion können aus beobachteten Variablen (etwa gelösten Mathematikaufgaben) Ausprägungen von Konstrukten (etwa mathematische Begabung eines Schülers) geschätzt werden


- [x] ❌
- [ ] 🔰
- [ ] ✅
> [!qq]- Was ist eine Latente Variable?
> - Parameter in einem mathematischen Modell (/statistischem Modell)
> - Sie repräsentiert das psychologische Konstrukt und wird aus empirischen Daten erschlossen


- [x] ❌
- [ ] 🔰
- [ ] ✅
> [!qq]- Was ist eine Manifeste Variable?
> - =  Operationalisierung der interessierenden latenten Variablen
> - Operationalisierung beruht auf 
> 	- einer möglichst <span style="color:rgb(0, 176, 240)">präzisen</span> Definition des psychologischen Konstrukts sowie 
> 	- einer <span style="color:rgb(0, 176, 240)">inhaltlich motivierten Ableitung</span> der manifesten Variablen (bzw. Indikatoren), 
> - Ziel: individuelle Unterschiede oder intraindividuelle Veränderungen in diesem Konstrukt mithilfe des Messinstruments messen


- [x] ❌
- [ ] 🔰
- [ ] ✅
> [!qq]- Was bedeuten Diagnose und Prognose?
> ![[Pasted image 20240707165232.png]]


- [x] ❌
- [ ] 🔰
- [ ] ✅
> [!qq]- Was ist der "Diagnostischer Prozess"?
> ![[Pasted image 20240707165420.png]]
...
>
>
>> [!qq]- Reliabilität - erkläre die drei Arten
> ![[Pasted image 20240707165540.png]]
...
- [ ] 🔰
- [ ] ✅
> [!qq]- Was bedeutet "[[Validität]]"? Erkläre auch die Positionen: Validität als Eigenschaft des Tests und als Eigenschaft der Testwerte.

> [!info] Weitere Gütekriterien
> - Vorliegen aktueller Normen
...
![[Pasted image 20240707172300.png]]


#### Probabilistische Item-Response-Modelle

Blabla

#### Konfirmatorische [[Strukturgleichungsmodelle]]

- Passt ein Strukturgleichungsmodell auf einen Sachverhalt (Gruppen, Messzeitpunkte)? Die Überprüfung erfolgt durch Betrachtung von Messinvarianzen. 
> [!qq] Frage
>- [ ] ❌
>- [ ] 🔰
>- [ ] ✅
>
>
>> [!qq]- Was ist [[Messinvarianz]]? Erkläre grob die verschiedenen Arten von Messinvarianz
